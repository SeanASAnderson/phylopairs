...
namespace model_betaols_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 44> locations_array__ =
  {" (found before start of program)",
  " (in 'betaols', line 20, column 2 to column 17)",
  " (in 'betaols', line 21, column 2 to column 20)",
  " (in 'betaols', line 47, column 2 to column 40)",
  " (in 'betaols', line 48, column 2 to column 37)",
  " (in 'betaols', line 51, column 4 to column 65)",
  " (in 'betaols', line 50, column 17 to line 52, column 3)",
  " (in 'betaols', line 50, column 2 to line 52, column 3)",
  " (in 'betaols', line 25, column 2 to column 23)",
  " (in 'betaols', line 26, column 2 to column 26)",
  " (in 'betaols', line 28, column 9 to column 10)",
  " (in 'betaols', line 28, column 2 to column 25)",
  " (in 'betaols', line 30, column 9 to column 10)",
  " (in 'betaols', line 30, column 2 to column 15)",
  " (in 'betaols', line 40, column 4 to column 25)",
  " (in 'betaols', line 39, column 31 to line 41, column 3)",
  " (in 'betaols', line 39, column 9 to line 41, column 3)",
  " (in 'betaols', line 38, column 4 to column 28)",
  " (in 'betaols', line 37, column 31 to line 39, column 3)",
  " (in 'betaols', line 37, column 9 to line 41, column 3)",
  " (in 'betaols', line 35, column 6 to column 39)",
  " (in 'betaols', line 34, column 19 to line 36, column 5)",
  " (in 'betaols', line 34, column 4 to line 36, column 5)",
  " (in 'betaols', line 33, column 31 to line 37, column 3)",
  " (in 'betaols', line 33, column 9 to line 41, column 3)",
  " (in 'betaols', line 32, column 4 to column 24)",
  " (in 'betaols', line 31, column 24 to line 33, column 3)",
  " (in 'betaols', line 31, column 2 to line 41, column 3)",
  " (in 'betaols', line 44, column 2 to column 37)",
  " (in 'betaols', line 7, column 2 to column 17)",
  " (in 'betaols', line 8, column 2 to column 17)",
  " (in 'betaols', line 9, column 26 to column 27)",
  " (in 'betaols', line 9, column 2 to column 31)",
  " (in 'betaols', line 10, column 9 to column 10)",
  " (in 'betaols', line 10, column 12 to column 13)",
  " (in 'betaols', line 10, column 2 to column 17)",
  " (in 'betaols', line 11, column 2 to column 17)",
  " (in 'betaols', line 12, column 2 to column 24)",
  " (in 'betaols', line 13, column 2 to column 26)",
  " (in 'betaols', line 14, column 2 to column 25)",
  " (in 'betaols', line 15, column 2 to column 36)",
  " (in 'betaols', line 20, column 9 to column 10)",
  " (in 'betaols', line 47, column 9 to column 10)",
  " (in 'betaols', line 48, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_betaols final : public model_base_crtp<model_betaols> {
private:
  int N;
  int K;
...
public:
  ~model_betaols() {}
  model_betaols(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_betaols_namespace::model_betaols";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_betaols_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_betaols_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_betaols_namespace::model_betaols;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_betaols_namespace::profiles__;
}
#endif
#endif
