...
namespace model_betamm_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 54> locations_array__ =
  {" (found before start of program)",
  " (in 'betamm', line 29, column 2 to column 17)",
  " (in 'betamm', line 30, column 2 to column 20)",
  " (in 'betamm', line 31, column 2 to column 27)",
  " (in 'betamm', line 32, column 2 to column 25)",
  " (in 'betamm', line 59, column 2 to column 40)",
  " (in 'betamm', line 60, column 2 to column 52)",
  " (in 'betamm', line 63, column 4 to column 65)",
  " (in 'betamm', line 62, column 17 to line 64, column 3)",
  " (in 'betamm', line 62, column 2 to line 64, column 3)",
  " (in 'betamm', line 36, column 2 to column 36)",
  " (in 'betamm', line 37, column 2 to column 35)",
  " (in 'betamm', line 38, column 2 to column 45)",
  " (in 'betamm', line 39, column 2 to column 63)",
  " (in 'betamm', line 41, column 9 to column 10)",
  " (in 'betamm', line 41, column 2 to column 15)",
  " (in 'betamm', line 42, column 9 to column 10)",
  " (in 'betamm', line 42, column 2 to column 40)",
  " (in 'betamm', line 53, column 4 to column 25)",
  " (in 'betamm', line 52, column 31 to line 54, column 3)",
  " (in 'betamm', line 52, column 9 to line 54, column 3)",
  " (in 'betamm', line 51, column 4 to column 28)",
  " (in 'betamm', line 50, column 31 to line 52, column 3)",
  " (in 'betamm', line 50, column 9 to line 54, column 3)",
  " (in 'betamm', line 48, column 6 to column 39)",
  " (in 'betamm', line 47, column 19 to line 49, column 5)",
  " (in 'betamm', line 47, column 4 to line 49, column 5)",
  " (in 'betamm', line 46, column 31 to line 50, column 3)",
  " (in 'betamm', line 46, column 9 to line 54, column 3)",
  " (in 'betamm', line 45, column 4 to column 24)",
  " (in 'betamm', line 44, column 24 to line 46, column 3)",
  " (in 'betamm', line 44, column 2 to line 54, column 3)",
  " (in 'betamm', line 56, column 2 to column 37)",
  " (in 'betamm', line 11, column 2 to column 17)",
  " (in 'betamm', line 12, column 2 to column 17)",
  " (in 'betamm', line 13, column 26 to column 27)",
  " (in 'betamm', line 13, column 2 to column 31)",
  " (in 'betamm', line 14, column 9 to column 10)",
  " (in 'betamm', line 14, column 12 to column 13)",
  " (in 'betamm', line 14, column 2 to column 17)",
  " (in 'betamm', line 15, column 9 to column 10)",
  " (in 'betamm', line 15, column 12 to column 13)",
  " (in 'betamm', line 15, column 2 to column 18)",
  " (in 'betamm', line 16, column 2 to column 17)",
  " (in 'betamm', line 17, column 2 to column 24)",
  " (in 'betamm', line 18, column 2 to column 26)",
  " (in 'betamm', line 19, column 2 to column 25)",
  " (in 'betamm', line 20, column 2 to column 17)",
  " (in 'betamm', line 21, column 2 to column 15)",
  " (in 'betamm', line 22, column 2 to column 36)",
  " (in 'betamm', line 29, column 9 to column 10)",
  " (in 'betamm', line 32, column 9 to column 10)",
  " (in 'betamm', line 59, column 9 to column 10)",
  " (in 'betamm', line 60, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_betamm final : public model_base_crtp<model_betamm> {
private:
  int N;
  int K;
...
public:
  ~model_betamm() {}
  model_betamm(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_betamm_namespace::model_betamm";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("pair_effects", "N", N);
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_betamm_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      phi = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      local_scalar_t__ sig2_scale = DUMMY_VAR__;
      current_statement__ = 3;
      sig2_scale = in__.template read_constrain_lb<local_scalar_t__,
                     jacobian__>(0, lp__);
                       ...
                       Eigen::Matrix<local_scalar_t__,-1,1>>(N);
      {
        ...
        lp_accum__.add(stan::math::lognormal_lpdf<propto__>(sig2_scale,
                         sig2_mean, sig2_sd));
        current_statement__ = 13;
        lp_accum__.add(stan::math::multi_normal_lpdf<propto__>(pair_effects,
                         stan::math::rep_vector(0, N),
                         stan::math::multiply(sig2_scale, Cp)));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_betamm_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      phi = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      double sig2_scale = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 3;
      sig2_scale = in__.template read_constrain_lb<local_scalar_t__,
                     jacobian__>(0, lp__);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ sig2_scale = DUMMY_VAR__;
      current_statement__ = 3;
      sig2_scale = in__.read<local_scalar_t__>();
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      local_scalar_t__ sig2_scale = DUMMY_VAR__;
      current_statement__ = 3;
      sig2_scale = context__.vals_r("sig2_scale")[(1 - 1)];
      out__.write_free_lb(0, sig2_scale);
      Eigen::Matrix<local_scalar_t__,-1,1> pair_effects =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(N, DUMMY_VAR__);
      {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"Coef\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sig2_scale\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"pair_effects\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"loglik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((K + 1) + 1) + N);
...
using stan_model = model_betamm_namespace::model_betamm;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_betamm_namespace::profiles__;
}
#endif
#endif
