...
#'   every pair. The model is \code{Y = Xb + Z1u1 + Z1u2 + eps}, where b is the vector of 
...
#'   effects to the correct species in each pair, and eps is residual error (eps~N(0,C)). 
