...
static constexpr std::array<const char*, 44> locations_array__ =
  ...
  " (in 'betareg', line 20, column 2 to column 17)",
  " (in 'betareg', line 21, column 2 to column 20)",
  " (in 'betareg', line 47, column 2 to column 40)",
  " (in 'betareg', line 48, column 2 to column 37)",
  " (in 'betareg', line 51, column 4 to column 65)",
  " (in 'betareg', line 50, column 17 to line 52, column 3)",
  " (in 'betareg', line 50, column 2 to line 52, column 3)",
  " (in 'betareg', line 25, column 2 to column 23)",
  " (in 'betareg', line 26, column 2 to column 26)",
  " (in 'betareg', line 28, column 9 to column 10)",
  " (in 'betareg', line 28, column 2 to column 25)",
  " (in 'betareg', line 30, column 9 to column 10)",
  " (in 'betareg', line 30, column 2 to column 15)",
  " (in 'betareg', line 40, column 4 to column 25)",
  " (in 'betareg', line 39, column 31 to line 41, column 3)",
  " (in 'betareg', line 39, column 9 to line 41, column 3)",
  " (in 'betareg', line 38, column 4 to column 28)",
  " (in 'betareg', line 37, column 31 to line 39, column 3)",
  " (in 'betareg', line 37, column 9 to line 41, column 3)",
  " (in 'betareg', line 35, column 6 to column 39)",
  " (in 'betareg', line 34, column 19 to line 36, column 5)",
  " (in 'betareg', line 34, column 4 to line 36, column 5)",
  " (in 'betareg', line 33, column 31 to line 37, column 3)",
  " (in 'betareg', line 33, column 9 to line 41, column 3)",
  " (in 'betareg', line 32, column 4 to column 24)",
  " (in 'betareg', line 31, column 24 to line 33, column 3)",
  " (in 'betareg', line 31, column 2 to line 41, column 3)",
  " (in 'betareg', line 44, column 2 to column 37)",
  " (in 'betareg', line 7, column 2 to column 17)",
  " (in 'betareg', line 8, column 2 to column 17)",
  " (in 'betareg', line 9, column 26 to column 27)",
  " (in 'betareg', line 9, column 2 to column 31)",
  " (in 'betareg', line 10, column 9 to column 10)",
  " (in 'betareg', line 10, column 12 to column 13)",
  " (in 'betareg', line 10, column 2 to column 17)",
  " (in 'betareg', line 11, column 2 to column 17)",
  " (in 'betareg', line 12, column 2 to column 24)",
  " (in 'betareg', line 13, column 2 to column 26)",
  " (in 'betareg', line 14, column 2 to column 25)",
  " (in 'betareg', line 15, column 2 to column 36)",
  " (in 'betareg', line 20, column 9 to column 10)",
  " (in 'betareg', line 47, column 9 to column 10)",
  " (in 'betareg', line 48, column 9 to column 10)"};
